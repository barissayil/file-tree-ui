(() => {
  ...
  var LineRangeMapping = class {
    ...
    flip() {
      var _a3;
      return new LineRangeMapping(this.modifiedRange, this.originalRange, (_a3 = this.innerChanges) === null || _a3 === void 0 ? void 0 : _a3.map((c) => c.flip()));
    }
  };
  ...
  var SimpleLineRangeMapping = class {
